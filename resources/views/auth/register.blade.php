...
<head>
    ...
    <title>{{ config('app.name', 'LRMackRD') }} - Registro</title>
    ...
    <div class="min-h-screen flex flex-col justify-center items-center p-6">
        ...
        <div class="w-full max-w-md bg-white rounded-xl shadow-xl overflow-hidden backdrop-blur-sm border border-gray-100">
            <div class="px-8 pt-8 pb-6 bg-gradient-to-r from-primary-50 to-white border-b border-gray-100">
                ...
                <p class="mt-2 text-secondary-600 text-center">Completa el formulario para registrarte</p>
            </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <div class="text-center">
                            <a href="{{ route('login') }}" class="text-sm font-medium text-primary-600 hover:text-primary-700 transition">
